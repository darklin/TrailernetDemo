<template>
  <div class="content-box">
    <div class="content-subtitle">{{$t('excel.importVehicle')}}</div>
    <div class="content-ctrl">
      <el-button class="table-normal-btn" @click="backHandle">{{$t('common.goback')}}</el-button>
    </div>
    <div class="content-form-box">
      <div class="content-form">
        <div class="content-form-title">{{$t('excel.importVehicle')}}</div>
...
export default {
  ...
  data () {
    return {
      dataType: 1,
      uploadURL: this.$baseURL + 'car/importExcel'
    }
  },
  created () {},
  methods: {
    // 下载车辆信息导入模板
    downloadTemplate () {
      window.location.href = `${this.$baseURL}car/templateExcel`
    },
    importVehicle () {
