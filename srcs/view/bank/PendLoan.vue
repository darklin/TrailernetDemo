<template>
  <div class="content-box">
    <el-breadcrumb separator=">">
      ...
      <el-breadcrumb-item>待放款</el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template scope="scope">
          <el-button @click="checkHandle(scope.row.customerId)" type="text" size="small">审核</el-button>
        </template>
      </el-table-column>
    </el-table>
    <div class="clearfix">
...
export default {
  name: 'pend-loan',
  data () {
    let form = this.$formStore('pendLoan')
    return {
      searchForm: {
  ...
  methods: {
    searchHandle (type) {
      ...
      this.$ajax({
        url: '/account/bank/getBankCheckList',
        data: this.searchForm,
        loading: loading,
        success: data => {
          this.$formStore('pendLoan', this.searchForm)
    ...
    checkHandle (id) {
      this.$router.push('pendLoanDesc' + id)
    }
  }
}
</script>
