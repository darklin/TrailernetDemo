        ...
        <el-form :inline="true" class="fl">
          <div>
            <el-form-item label="贷款金额">
              <el-input v-model="checkForm.loanAmount" disabled>
                <template slot="append">元</template>
              </el-input>
            </el-form-item>
            <el-form-item label="贷款期限">
              <el-input v-model="checkForm.loanDeadline" disabled>
                <template slot="append">个月</template>
              </el-input>
            </el-form-item>
            <el-form-item label="贷款利率">
              <el-input v-model="checkForm.loanRate" disabled></el-input>
            </el-form-item>
          </div>
          <div>
            <el-form-item label="贷款利息">
              <el-input v-model="checkForm.totalInterest" disabled>
                <template slot="append">元</template>
              </el-input>
            </el-form-item>
          </div>
          <div>
            <el-form-item label="还款方式">
              <el-radio-group v-model="checkForm.repayType" disabled>
                <el-radio :label="1">等额还款</el-radio>
                <el-radio :label="2">先息后款</el-radio>
              </el-radio-group>
          ...
          <div>
            <el-form-item label="复核描述">
              <el-input
                ...
                :rows="2"
                resize="none"
                v-model="checkForm.reviewDes" disabled>
              </el-input>
            </el-form-item>
          </div>
        </el-form>
...
export default {
  ...
  created () {
    this.$ajax({
      url: '/account/check/reviewhandle/getLoanDetail',
